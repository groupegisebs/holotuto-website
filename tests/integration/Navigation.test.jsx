...
describe('Navigation — liens desktop', () => {
  ...
  it('le CTA "Essayer gratuitement" pointe vers holotuto.com', async () => {
    await renderWithI18n(<Navbar />, { lng: 'fr' })
...
describe('Navigation — flux menu mobile complet', () => {
  ...
  it('le drawer mobile contient aussi les boutons CTA', async () => {
    ...
    // Essai gratuit → liens vers holotuto.com (desktop + mobile drawer)
    const tryLinks = document.querySelectorAll('a[href="https://holotuto.com"]')
