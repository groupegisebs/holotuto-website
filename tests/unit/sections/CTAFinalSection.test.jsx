...
describe('CTAFinalSection — CTA', () => {
  it('contient un lien CTA d\'essai vers myholo.holotuto.com (btn-primary)', async () => {
    await renderWithI18n(<CTAFinalSection />)
    expect(document.querySelector('a[href="https://www.myholo.holotuto.com/"].btn-primary')).toBeInTheDocument()
  })
